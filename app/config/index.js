...
function argv(configPath) {
	let serviceWorkerFolder = Path.join(configPath, '/Partitions/teams-4-linux/Service Worker');
	fs.rmdirSync(serviceWorkerFolder, { recursive: true });
	console.log('deleted service worker: ' + serviceWorkerFolder);
